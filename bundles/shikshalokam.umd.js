(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/forms'), require('@angular/material/select'), require('@angular/common'), require('@angular/material'), require('@angular/router'), require('@angular/http'), require('@angular/core'), require('@angular/common/http'), require('@angular/material/dialog'), require('@angular/material/button'), require('@angular/material/progress-spinner'), require('@angular/material/snack-bar'), require('ngx-spinner')) :
    typeof define === 'function' && define.amd ? define('shikshalokam', ['exports', 'rxjs', 'rxjs/operators', '@angular/forms', '@angular/material/select', '@angular/common', '@angular/material', '@angular/router', '@angular/http', '@angular/core', '@angular/common/http', '@angular/material/dialog', '@angular/material/button', '@angular/material/progress-spinner', '@angular/material/snack-bar', 'ngx-spinner'], factory) :
    (factory((global.shikshalokam = {}),global.rxjs,global.rxjs.operators,global.ng.forms,global.ng.material.select,global.ng.common,global.ng.material,global.ng.router,global.ng.http,global.ng.core,global.ng.common.http,global.ng.material.dialog,global.ng.material.button,global.ng.material['progress-spinner'],global.ng.material['snack-bar'],global.i2));
}(this, (function (exports,rxjs,operators,forms,select,i1,material,router,http,i0,i1$1,dialog,button,progressSpinner,snackBar,i2) { 'use strict';
    ...
    var SearchDirective = /** @class */ (function () {
        function SearchDirective() {
            this.sendSearchValue = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
         ...
         */
            function () {
                ...
                /** @type {?} */
                var example = rxjs.fromEvent(input, 'keyup');
                /** @type {?} */
                var debouncedInput = example.pipe(operators.debounceTime(1000));
                /** @type {?} */
        ...
        SearchDirective.propDecorators = {
            ...
            sendSearchValue: [{ type: i0.Output }]
        };
    ...
    var SharedModule = /** @class */ (function () {
        ...
        SharedModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        exports: [DynamicFormComponent, i2.NgxSpinnerModule, BreadcrumbComponent, ParentHeadingComponent, snackBar.MatSnackBarModule, ImageCardComponent, LoaderComponent, SearchDirective, DashboardBlocksComponent]
                    },] }
        ];
        return SharedModule;
    }());
